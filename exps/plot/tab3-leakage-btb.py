...
# read file
f1 = open('../res/exp4_btb_access_1.txt', 'r')
f2 = open('../res/exp4_btb_access_2.txt', 'r')
f3 = open('../res/exp4_btb_access_3.txt', 'r')
f4 = open('../res/exp4_btb_access_4.txt', 'r')
lines1 = f1.readlines()
lines2 = f2.readlines()
lines3 = f3.readlines()
lines4 = f4.readlines()
...
# parse data to 63 * 200 matrix
data1 = np.zeros((63, 200))
data2 = np.zeros((63, 200))
data3 = np.zeros((63, 200))
data4 = np.zeros((63, 200))
...
leakage_1 = np.zeros((7, 200))
leakage_2 = np.zeros((7, 200))
leakage_4 = np.zeros((7, 200))
for i in range(7):
    for j in range(200):
        # dump collision data

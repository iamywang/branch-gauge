...
# read file
f = open('../res/exp3_pht_collision_rate.txt', 'r')
lines = f.readlines()
f.close()

num_repeats = 1000

# parse data to 7 * 500 matrix (1000 to 500000)
data = np.zeros((7, 500))
...
x = [50000, 100000, 150000, 200000, 250000, 300000, 350000, 400000, 450000, 500000]
bar_width = 0.13

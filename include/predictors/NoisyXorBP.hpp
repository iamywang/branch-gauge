...
// =============================================================================
#ifndef NOISY_XOR_BP_HPP
#define NOISY_XOR_BP_HPP
#include <cmath>
#include <cstdint>
#include <cstdlib>
#include <vector>
...
class NoisyXorBP {
 ...
 public:
  NoisyXorBP(uint64_t addr_space = 32) : addr_space(addr_space) {
#ifdef RANDOM_KEY
    ...
    this->content_keys = {EncryptionKey::KEY_2, EncryptionKey::KEY_3};
#endif
  }
